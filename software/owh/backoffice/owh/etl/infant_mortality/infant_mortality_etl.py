...
class InfantMortalityETL (ETL):
    ...
    def updateDsMetadata(self):
        ...
        self.loadDataSetMetaData('infant_mortality', '2007', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2008', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2009', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2010', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2011', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2012', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2013', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2014', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2015', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2016', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
        self.loadDataSetMetaData('infant_mortality', '2017', os.path.join(self.dataDirectory, 'data_mapping', 'infant_2007_2017.json'))
