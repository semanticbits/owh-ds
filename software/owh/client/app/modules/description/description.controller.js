    ...
    function DescriptionController($scope, $state, $stateParams, $location) {
        ...
        dc.datasetInfo = {
                ...
                prams: {
                    ...
                    announcement:"PRAMS data from 2012-2014 are being updated during the week of 05/21/2018. Advanced search with updated data will be available coming weeks",
