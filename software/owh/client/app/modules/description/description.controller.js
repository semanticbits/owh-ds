        ...
        dc.datasetInfo = {
                births: {
                    ...
                    filters: [
                        ...
                        {name: "Pre-pregnancy Hypertension", description: "This field indicates whether Pre-pregnancy Hypertension is reported as a maternal risk factor"},
                        {name: "Gestational Hypertension", description: "This field indicates whether Gestational Hypertension is reported as a maternal risk factor"},
                        {name: "Diabetics", description: "This field indicates whether Diabetes is reported as a maternal risk factor."},
                        {name: "Pre-pregnancy Diabetics", description: "This field indicates whether Pre-pregnancy Diabetics is reported as a maternal risk factor."},
                        {name: "Gestational Diabetics", description: "This field indicates whether Gestational Diabetics is reported as a maternal risk factor."},
