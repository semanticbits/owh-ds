    ...
    function searchFactory( utilService, SearchService, $q, $translate, chartUtilService, $rootScope, $timeout, $filter, ModalService, $state, filterUtils, mapService){
        ...
        function getAllFilters() {
            ...
            filters.yrbsAdvancedFilters = [
                {key: 'year', title: 'label.yrbs.filter.year', queryKey:"year",primary: false, value: ['2019'], groupBy: false,
            ...
            filters.yrbsBasicFilters = [
                {key: 'year', title: 'label.yrbs.filter.year', queryKey:"year",primary: false, value: '2019', groupBy: false,defaultGroup:"column",
