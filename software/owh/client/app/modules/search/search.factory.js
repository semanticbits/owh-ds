    ...
    function searchFactory( utilService, SearchService, $q, $translate, chartUtilService, $rootScope, $timeout, $filter, ModalService, $state, filterUtils, mapService){
        ...
        function getAllFilters() {
            ...
            filters.brfsTopicOptions = [
                ...
                {"key": "cat_38", "title": "Arthritis"},
                {"key": "cat_32", "title": "Asthma"},
                {"key": "cat_31", "title": "BMI Categories"},
                {"key": "cat_51", "title": "Binge Drinking"},
                {"key": "cat_42", "title": "Blood Stool Test"},
                {"key": "cat_4",  "title": "COPD"},
                {"key": "cat_10", "title": "Cardiovascular Disease"},
                {"key": "cat_3",  "title": "Cholesterol Checked"},
                {"key": "cat_52", "title": "Cholesterol High"},
                {"key": "cat_34", "title": "Colonoscopy"},
                {"key": "cat_59", "title": "Current Smoker Status"},
                ...
                {"key": "cat_44", "title": "Sigmoidoscopy"},
                {"key": "cat_7",  "title": "Skin Cancer"},
                {"key": "cat_28", "title": "Smokeless Tobacco"},
                {"key": "cat_60", "title": "Smoker Status"},
                {"key": "cat_49", "title": "Strength Activity"},
                {"key": "cat_40", "title": "Teeth Removed"},
                {"key": "cat_27", "title": "Tetanus Shot"},
                {"key": "cat_35", "title": "USPSTF Recommendations"},
                {"key": "cat_45", "title": "Under 65 Coverage"},
                {"key": "cat_62", "title": "Vegetable Consumption"},
