(function () {
    ...
    function filterUtils(utilService, $timeout, $rootScope) {
        ...
        return {
            ...
            getBRFSSFilters: getBRFSSFilters,
            getBrfsTopics: getBrfsTopics
        };
        ...
        /**
         * Build and return BRFSS filters
         * @returns {[*,*,*,*,*,*,*,*,*]}
         */
        function getBRFSSFilters() {

            var topicOptions = getBrfsTopics();
            ...
            return [
                {
                    ...
                    value: [], groupBy: false,
                    filterType: 'checkbox', autoCompleteOptions: topicOptions,
                ...
                },
                {
                    ...
                    groupBy: false, filterType: 'radio',
                    autoCompleteOptions: raceOptions,
                    doNotShowAll: false, helpText: ""
                },
                {
                    ...
                    groupBy: false, filterType: 'radio',
                    autoCompleteOptions: ageGroupOptions,
                    doNotShowAll: false, helpText: ""
                },
                {
                    ...
                    groupBy: false, filterType: 'radio',
                    autoCompleteOptions: educationOptions,
                    doNotShowAll: false, helpText: ""
                },
                {
                    ...
                    groupBy: false, filterType: 'radio',
                    autoCompleteOptions: incomeOptions,
                    doNotShowAll: false, helpText: ""
                },
                {
