...
describe('filterUtils', function(){
    ...
    describe('STD filters -> ', function() {
        it('when I call getSTDDataFilters, I should get all std filters', function () {
            ...
            expect(stdDataFilters[3].autoCompleteOptions.length).toEqual(18);
            ...
            expect(stdDataFilters[3].autoCompleteOptions[2].key).toEqual("05-14");
            expect(stdDataFilters[3].autoCompleteOptions[3].key).toEqual("13-24");
            expect(stdDataFilters[3].autoCompleteOptions[4].key).toEqual("15-19");
            expect(stdDataFilters[3].autoCompleteOptions[5].key).toEqual("15-24");
            expect(stdDataFilters[3].autoCompleteOptions[6].key).toEqual("20-24");
            expect(stdDataFilters[3].autoCompleteOptions[7].key).toEqual("25-29");
            expect(stdDataFilters[3].autoCompleteOptions[8].key).toEqual("25-34");
            expect(stdDataFilters[3].autoCompleteOptions[9].key).toEqual("30-34");
            expect(stdDataFilters[3].autoCompleteOptions[10].key).toEqual("35-39");
            expect(stdDataFilters[3].autoCompleteOptions[11].key).toEqual("35-44");
            expect(stdDataFilters[3].autoCompleteOptions[12].key).toEqual("40-44");
            expect(stdDataFilters[3].autoCompleteOptions[13].key).toEqual("45-54");
            expect(stdDataFilters[3].autoCompleteOptions[14].key).toEqual("55-64");
            expect(stdDataFilters[3].autoCompleteOptions[15].key).toEqual("55+");
            expect(stdDataFilters[3].autoCompleteOptions[16].key).toEqual("65+");
            expect(stdDataFilters[3].autoCompleteOptions[17].key).toEqual("Unknown");
