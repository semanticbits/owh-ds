...
describe('chart utils', function(){
    ...
    it('test chart horizontalBar for PRAMS single filter', function () {
        ...
        var expectedOutput = {
            ...
            "title":"label.prams.filter.state and label.prams.filter.state",
            "longtitle":"chart.title.measure.prams by label.prams.filter.state in undefined for undefined",
            "dataset":"prams",
            "data":[
                {
                    "name":"Percentage - YES (CHECKED)",
                    "x":[
                        2.6
                    ],
                    "y":[
            ...
            "layout":{
                ...
                "yaxis":{
                    ...
                    "showticklabels":false,
                    "fixedrange":true,
                    "title":"label.prams.filter.state"
                },
                "barmode":"bar"
            },
            "options":{
