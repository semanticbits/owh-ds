...
var cancerMortalityStepDefinitions = function () {
    ...
    this.Then(/On the cancer mortality page, the visualization is displayed/, function (next) {
        cancerMortalityPage.isVisualizationDisplayed().then(function (value) {
            expect(value).to.be.true;
        }).then(next);
    });
};

module.exports = cancerMortalityStepDefinitions;
